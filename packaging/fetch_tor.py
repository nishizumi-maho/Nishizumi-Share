...
#: Bump this to ship a newer Tor. Keep it on a stable Tor Browser release.
DEFAULT_VERSION = "14.5.8"
...
def main() -> int:
    ...
    archive_name = bundle_name(args.version, args.platform)
    base_url = f"{DIST_BASE}/{args.version}"

    print(f"Tor Expert Bundle {args.version} ({args.platform})")
